...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # оба элемента ее списка Эдит интересно, запомнит ли сайт ее список. Далее она видит, что # сайт сгенерировал
        # для нее уникальный URL-адрес – об этом выводится небольшой текст с объяснениями. Она посещает этот
